// Día 10 — Interpretación de Graficos y Tablas (Módulo B)
registerPresentation(10, 'B', 'Interpretación de Graficos y Tablas', [

    // --- SLIDE 1: Titulo ---
    {
        tipo: "titulo",
        modulo: "B",
        titulo: "Interpretación de Graficos y Tablas",
        subtitulo: "Día 10 — Módulo B: Competencia Matemática | Histogramas, frecuencias y lectura visual de datos"
    },
    ...
    // --- SLIDE 2: Introducción ---
    {
        ...
        <ul>
            <li><strong>Módulo B</strong> tiene 30 reactivos; al menos 5-7 involucran graficos o tablas</li>
            <li>Son preguntas de <strong>razonamiento visual</strong>, no de cálculo puro</li>
            <li>Los errores más comunes vienen de <strong>leer mal los ejes</strong> o confundir porcentajes con valores absolutos</li>
        </ul>
    ...
    // --- SLIDE 3: Tipos de graficos ---
    {
        ...
        contenido: `<table>
            ...
            <tr><td><strong>Circular (pastel)</strong></td><td>Mostrar proporciones del 100%</td><td>Distribución de escaños</td></tr>
            <tr><td><strong>Histograma</strong></td><td>Distribución de datos continuos</td><td>Edades de funcionarios de casilla</td></tr>
            <tr><td><strong>Poligono de frecuencia</strong></td><td>Tendencia en datos agrupados</td><td>Evolucion de participación por rango de edad</td></tr>
            <tr><td><strong>Linea (serie de tiempo)</strong></td><td>Cambio a lo largo del tiempo</td><td>Participación electoral 2000-2024</td></tr>
            <tr><td><strong>Caja y bigotes</strong></td><td>Dispersion y valores atípicos</td><td>Votos por casilla en un distrito</td></tr>
    ...
    // --- SLIDE 4: Concepto clave ---
    {
        ...
        frente: "Cuál es la diferencia fundamental entre un histograma y una grafica de barras?",
        reverso: "El <strong>histograma</strong> usa intervalos continuos (rangos numericos como 18-25 años) y las barras van pegadas. La <strong>grafica de barras</strong> usa categorias discretas (Partido A, Partido B) y las barras van separadas. Si ves barras pegadas, es histograma. Si están separadas, son barras."
    },
    ...
    // --- SLIDE 5: Grafica de barras ---
    {
        ...
        contenido: `<p>En una elección distrital, los resultados fueron:</p>
        <table>
        ...
        <p><strong>Pregunta tipica CENEVAL:</strong> "Cuál es la diferencia entre el primer y tercer lugar?"</p>
    ...
    // --- SLIDE 6: Grafica circular ---
    {
        ...
        <ul>
            ...
            <li><strong>Trampa CENEVAL:</strong> Poner como opción el porcentaje cuando preguntan el valor absoluto (o viceversa)</li>
        </ul>
        <p><strong>Cuando se usa en contexto electoral:</strong></p>
        <ul>
            <li>Distribución del financiamiento público entre partidos</li>
            <li>Composicion de la Cámara de Diputados por partido</li>
            <li>Porcentaje de participación vs abstencion</li>
        </ul>`
    },

    // --- SLIDE 7: Fórmula de frecuencia ---
    {
        tipo: "formula",
    ...
    // --- SLIDE 8: Tablas de frecuencia ---
    {
        ...
        <p><strong>Dato clave:</strong> El grupo más numeroso (26-35) se llama <strong>clase modal</strong>.</p>`
    },
    ...
    // --- SLIDE 9: Quiz 1 ---
    {
        tipo: "quiz",
        titulo: "Tablas de frecuencia",
        pregunta: "Usando la tabla anterior: si quieres saber cuantos funcionarios tienen 35 años o menos, que columna consultas?",
        opciones: [
        ...
        respuesta: 1,
        feedbackOk: "Correcto! La frecuencia acumulada te dice cuantos datos hay hasta ese intervalo. Para 35 años o menos: 107 funcionarios.",
    ...
    // --- SLIDE 10: Tablas de doble entrada ---
    {
        ...
        contenido: `<p>Relacióna dos variables simultaneamente. Muy frecuente en el CENEVAL.</p>
        <table>
        ...
        <ul>
            <li>"Qué porcentaje de la zona rural voto a favor?" = 180/500 = <strong>36%</strong></li>
    ...
    // --- SLIDE 12: Graficas de linea ---
    {
        ...
        <ul>
            <li><strong>Eje X:</strong> siempre es el tiempo (años, meses, jornadas)</li>
            <li><strong>Eje Y:</strong> la variable medida (participación, votos, presupuesto)</li>
            <li><strong>Linea ascendente:</strong> la variable crece</li>
            <li><strong>Linea descendente:</strong> la variable decrece</li>
            <li><strong>Pico:</strong> punto máximo local</li>
            <li><strong>Valle:</strong> punto mínimo local</li>
        </ul>
        <p><strong>Pregunta tipica:</strong> "En que período hubo el mayor incremento de participación?" Busca el tramo donde la linea sube más pronunciadamente.</p>`
    },
    ...
    // --- SLIDE 13: Diagrama de caja ---
    {
        ...
        <ul>
            <li><strong>Mínimo:</strong> el dato más pequeno (inicio del bigote izquierdo)</li>
            ...
            <li><strong>Máximo:</strong> el dato más grande (final del bigote derecho)</li>
        </ul>
        <p><strong>Rango intercuartilico (IQR):</strong> Q3 - Q1. Mide la dispersion del 50% central de los datos.</p>
        <p><strong>Valores atípicos:</strong> puntos fuera de los bigotes. Indican datos inusuales (ej: una casilla con participación anomalamente alta).</p>`
    },

    // --- SLIDE 14: Quiz 2 ---
    {
        tipo: "quiz",
        titulo: "Interpretación de graficos",
        pregunta: "En un diagrama de caja y bigotes sobre votos por casilla, la mediana es 350 y Q1 es 280. Si Q3 es 420, cuál es el rango intercuartilico (IQR)?",
        opciones: [
            "A) 70",
            "B) 140",
            "C) 350"
    ...
    // --- SLIDE 16: Trampas comunes ---
    {
        ...
        contenido: `<ol>
            ...
            <li><strong>Porcentaje vs absoluto:</strong> preguntan votos pero las opciones están en porcentaje</li>
            ...
            <li><strong>Interpolación enganiosa:</strong> inferir datos entre dos puntos de una linea</li>
            <li><strong>Correlación como causalidad:</strong> dos lineas suben juntas pero no están relacionadas</li>
        </ol>`
    },
    ...
    // --- SLIDE 17: Quiz 3 ---
    {
        ...
        pregunta: "Una grafica circular muestra: Partido A 35%, Partido B 28%, Partido C 22%, Otros 20%. Qué error tiene este grafico?",
        opciones: [
            "A) Los porcentajes no suman 100% (suman 105%)",
            "B) No tiene error, es una distribución valida",
            "C) Los porcentajes deberian ser números enteros"
        ],
        respuesta: 0,
    ...
    // --- SLIDE 18: Conversion entre representaciónes ---
    {
        tipo: "concepto",
        titulo: "Conversion tabla a grafico",
        frente: "Si tienes datos de votos por partido (categorias discretas), que tipo de grafico es el más apropiado?",
    ...
    // --- SLIDE 19: Resumen ---
    {
        ...
        puntos: [
            ...
            "Caja y bigotes: IQR = Q3 - Q1. Puntos fuera de bigotes = valores atípicos",
