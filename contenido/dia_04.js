// Día 4 — Ortografía y Acentuación RAE 2010 (Módulo A)
registerPresentation(4, 'A', 'Ortografía y Acentuación RAE 2010', [

    // --- SLIDE 1: Titulo ---
    {
        tipo: "titulo",
        modulo: "A",
        titulo: "Ortografía y Acentuación RAE 2010",
        subtitulo: "Día 4 — Módulo A: Lenguaje y Comunicación | Reglas RAE 2010, tilde diacritica, diptongos e hiatos"
    },

    // --- SLIDE 2: Introducción ---
    {
        tipo: "contenido",
        titulo: "Por que es crítico este tema?",
        contenido: `<p>El CENEVAL <strong>no evalua reglas básicas</strong> de acentuación (agudas, graves, esdrujulas). Su enfoque esta en las <strong>excepciones y los cambios de la RAE 2010</strong>.</p>
        <ul>
            <li>Un error de acentuación en un Acta Circunstanciada puede <strong>alterar el sentido jurídico</strong> del documento</li>
            <li>La normativa vigente es la <strong>Ortografía de la lengua espanola (2010)</strong></li>
    ...
    // --- SLIDE 3: Regla RAE 2010 - solo y demostrativos ---
    {
        ...
        explicacion: "Desde la Ortografía de 2010, ni el adverbio 'solo' (= solamente) ni los pronombres demostrativos llevan tilde, incluso si hay ambiguedad. En examenes de opción multiple, la forma sin tilde es siempre la respuesta correcta."
    },

    // --- SLIDE 4: Ejemplo - solo y demostrativos ---
    {
        tipo: "ejemplo",
        titulo: "Aplicación electoral: 'solo' y demostrativos",
        contenido: `<p><strong>Contexto:</strong> Redacción de actas electorales.</p>
    ...
    // --- SLIDE 6: Tilde diacritica ---
    {
        ...
        contenido: `<table>
            <tr><th>Con tilde</th><th>Función</th><th>Sin tilde</th><th>Función</th></tr>
            <tr><td><strong>el</strong> (con tilde)</td><td>Pronombre personal</td><td><strong>el</strong></td><td>Artículo</td></tr>
    ...
    // --- SLIDE 7: Aun / Aun ---
    {
        ...
        explicacion: "Ejemplo con tilde: 'El PREP aun no arroja resultados definitivos' (= todavia). Ejemplo sin tilde: 'Aun cuando llovio, la casilla se instalo' (= incluso cuando). Esta distinción es una de las trampas más frecuentes del CENEVAL."
    },
    ...
    // --- SLIDE 9: Monosilabos ortograficos ---
    {
        ...
        <p><strong>Alerta CENEVAL:</strong> Quien escriba "guion" con tilde comete un error según la norma vigente. Esta es una pregunta recurrente.</p>`
    },
    ...
    // --- SLIDE 10: Concepto - hiato vs diptongo ---
    {
        ...
        frente: "Cuál es la diferencia entre hiato y diptongo, y como afecta la acentuación?",
    ...
    {
        tipo: "contenido",
        titulo: "Acentuación en palabras compuestas",
        ...
        <ol>
            ...
            <li><strong>Compuestas con guion:</strong> ambos elementos conservan su acentuación.
                <ul>
    ...
    // --- SLIDE 13: Coma criminal ---
    {
        ...
        explicacion: "Error clasico: 'Los representantes de los partidos acreditados ante este órgano, firmaron bajo protesta.' La coma antes de 'firmaron' es incorrecta porque separa sujeto de predicado. Correccion: eliminar esa coma."
    },
    ...
    // --- SLIDE 14: Tipos de coma ---
    {
        ...
        contenido: `<ul>
            <li><strong>Coma de inciso:</strong> aisla una aclaracion. Siempre van DOS comás (apertura y cierre).
        ...
        <p><strong>Trampa CENEVAL:</strong> Si falta una de las dos comás del inciso, la oracion es incorrecta.</p>`
    },
    ...
    // --- SLIDE 15: Grafias - sino vs si no ---
    {
        ...
        reverso: "<strong>Sino</strong> (junto): conjuncion adversativa que contrapone. 'No gano el partido rojo, sino el azul.' También puede ser sustantivo (destino). <strong>Si no</strong> (separado): conjuncion condicional 'si' + adverbio 'no'. 'Se suspendera la sesion si no hay quorum.' Truco: si puedes insertar una palabra entre 'si' y 'no' (si acaso no...), va separado."
    },

    // --- SLIDE 16: Grafias - porque / por que ---
    {
        tipo: "contenido",
        titulo: "Las cuatro formás de 'porque'",
        contenido: `<table>
            <tr><th>Forma</th><th>Función</th><th>Ejemplo electoral</th></tr>
    ...
    // --- SLIDE 17: Quiz 2 - Puntuación ---
    {
        tipo: "quiz",
        titulo: "Puntuación estilo CENEVAL",
        pregunta: "Seleccióne la opción donde el uso de signos de puntuación sea CORRECTO en toda la oracion:",
        opciones: [
            "A) Aun cuando los representantes de la coalición llegaron tarde exigieron que se abriera, el paquete electoral retenido.",
            "B) Aun cuando los representantes de la coalición llegaron tarde, exigieron que se abriera el paquete electoral retenido.",
            "C) Aun cuando, los representantes de la coalición llegaron tarde exigieron que se abriera el paquete electoral retenido."
        ],
        respuesta: 1,
    ...
    // --- SLIDE 18: Quiz 3 - Acentuación ---
    {
        tipo: "quiz",
        titulo: "Errores de acentuación RAE 2010",
        pregunta: "Cual de las siguientes palabras esta MAL acentuada según la RAE 2010?",
        opciones: [
            "A) guion (con tilde)",
    ...
    // --- SLIDE 19: Resumen ---
    {
        ...
        puntos: [
            "'Solo', 'este', 'ese', 'aquel' NO llevan tilde según la RAE 2010, ni siquiera por ambiguedad",
            ...
            "Las cuatro formás de 'porque' tienen funciones distintas: pregunta, causa, sustantivo y relativo"
        ]
    }
]);
