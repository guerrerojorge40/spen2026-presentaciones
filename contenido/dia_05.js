// Día 5 — Vicios de Dicción (Módulo A)
registerPresentation(5, 'A', 'Vicios de Dicción', [

    // --- SLIDE 1: Titulo ---
    {
        tipo: "titulo",
        modulo: "A",
        titulo: "Vicios de Dicción",
        subtitulo: "Día 5 — Módulo A: Lenguaje y Comunicación | Dequeismo, queismo, pleonasmos, barbarismos y coherencia textual"
    },

    // --- SLIDE 2: Introducción ---
    {
        tipo: "contenido",
        titulo: "Que son los vicios de dicción?",
        contenido: `<p>Los vicios de dicción son <strong>errores en la construccion o uso del lenguaje</strong> que afectan la claridad, correccion o elegancia de la expresión. El CENEVAL los evalua de forma intensiva en el Módulo A.</p>
        <ul>
            <li><strong>Dequeismo y queismo:</strong> los más frecuentes en el examen</li>
            ...
            <li><strong>Coherencia textual:</strong> lógica interna del texto</li>
        </ul>
    ...
    // --- SLIDE 3: Dequeismo definición ---
    {
        tipo: "formula",
        titulo: "El Dequeismo: definición y regla",
    ...
    // --- SLIDE 5: Queismo definición ---
    {
        tipo: "formula",
        titulo: "El Queismo: definición y regla",
    ...
    // --- SLIDE 8: Quiz 1 - Dequeismo y queismo ---
    {
        ...
        respuesta: 2,
        feedbackOk: "Correcto. 'Coincidir' exige la preposicion 'en' (coincidieron en eso). La opción A es dequeismo: se informa algo, no de algo. La opción B es queismo: se tiene esperanza de algo, no esperanza algo.",
    ...
    // --- SLIDE 9: Pleonasmos ---
    {
        ...
        <p><strong>En contexto electoral:</strong> "El resultado arrojado y emitido por el computo final total de las casillas escrutadas" contiene redundancia excesiva que viola las normás de claridad del SPEN.</p>`
    },
    ...
    // --- SLIDE 12: Anacoluto ---
    {
        ...
        <p><strong>Correccion:</strong> "Con respecto a los paquetes no entregados, se detérmino multar a los responsables de su custodia."</p>
    ...
    {
        tipo: "contenido",
        titulo: "Coherencia textual: la lógica del texto",
        contenido: `<p>La coherencia evalua que un texto tenga un <strong>esquema lógico completo</strong>. Los vicios de coherencia incluyen:</p>
        <ul>
            <li><strong>Redundancia:</strong> repetir la misma idea con diferentes palabras</li>
            <li><strong>Contradicción:</strong> afirmar algo y luego negarlo sin justificacion</li>
        ...
        <p><strong>En el examen:</strong> Las preguntas de coherencia suelen presentar un párrafo con un error lógico oculto y pedir que identifiques la oracion problematica.</p>`
    },

    // --- SLIDE 14: Quiz 2 - Vicios diversos ---
    {
        tipo: "quiz",
        titulo: "Identificacion de vicios de dicción",
        pregunta: "Cual de las siguientes oraciones contiene un pleonasmo?",
        opciones: [
            "A) El tribunal detérmino que la sentencia era firme e inapelable.",
            "B) Los funcionarios de casilla deben prever con anticipacion los problemás logisticos.",
    ...
    {
        tipo: "quiz",
        titulo: "Aplicación del truco de sustitución",
    ...
    // --- SLIDE 16: Estrategia CENEVAL ---
    {
        ...
        <ol>
            ...
            <li><strong>Correccion:</strong> "Cuál es la forma correcta de la siguiente oracion?" — Te dan la oracion con error y debes elegir la version corregida</li>
            <li><strong>Selección negativa:</strong> "Cual de las siguientes oraciones NO presenta un vicio gramatical?" — Todas tienen errores excepto una</li>
        </ol>
        <p><strong>Estrategia clave:</strong> En preguntas de selección negativa, descarta primero las opciones con errores evidentes. La opción correcta suele ser la que tiene la estructura más "natural" y completa.</p>`
    },
    ...
    // --- SLIDE 17: Concepto - Haber impersonal ---
    {
        ...
        frente: "Por que es incorrecto decir 'hubieron muchos votos nulos' y cuál es la forma correcta?",
